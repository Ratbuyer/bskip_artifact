        ...
        std::vector<int> &ops)
{
    ...
    if (ap == UNIFORM) {
        if (kt == RANDINT_KEY && wl == WORKLOAD_A) {
            init_file = "/home/eddy/datasets/uniform/loada_unif_int.dat";
            txn_file = "/home/eddy/datasets/uniform/txnsa_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_B) {
            init_file = "/home/eddy/datasets/uniform/loadb_unif_int.dat";
            txn_file = "/home/eddy/datasets/uniform/txnsb_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_C) {
            init_file = "/home/eddy/datasets/uniform/loadc_unif_int.dat";
            txn_file = "/home/eddy/datasets/uniform/txnsc_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_D) {
            init_file = "/home/eddy/datasets/uniform/loadd_unif_int.dat";
            txn_file = "/home/eddy/datasets/uniform/txnsd_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_E) {
            init_file = "/home/eddy/datasets/uniform/loade_unif_int.dat";
            txn_file = "/home/eddy/datasets/uniform/txnse_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_X) {
            init_file = "/home/eddy/datasets/uniform/loadx_unif_int.dat";
            txn_file = "/home/eddy/datasets/uniform/txnsx_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_Y) {
            init_file = "/home/eddy/datasets/uniform/loadx_unif_int.dat";
            txn_file = "/home/eddy/datasets/uniform/txnsy_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_Z) {
            init_file = "/home/eddy/datasets/custom/uniform/insert_100/loada_unif_int.dat";
            txn_file = "/home/eddy/datasets/custom/uniform/insert_100/txnsa_unif_int.dat";
        }
    } else {
        if (kt == RANDINT_KEY && wl == WORKLOAD_A) {
            init_file = "/home/eddy/datasets/zipfian/loada_unif_int.dat";
            txn_file = "/home/eddy/datasets/zipfian/txnsa_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_B) {
            init_file = "/home/eddy/datasets/zipfian/loadb_unif_int.dat";
            txn_file = "/home/eddy/datasets/zipfian/txnsb_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_C) {
            init_file = "/home/eddy/datasets/zipfian/loadc_unif_int.dat";
            txn_file = "/home/eddy/datasets/zipfian/txnsc_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_D) {
            init_file = "/home/eddy/datasets/zipfian/loadd_unif_int.dat";
            txn_file = "/home/eddy/datasets/zipfian/txnsd_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_E) {
            init_file = "/home/eddy/datasets/zipfian/loade_unif_int.dat";
            txn_file = "/home/eddy/datasets/zipfian/txnse_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_X) {
            init_file = "/home/eddy/datasets/zipfian/loadx_unif_int.dat";
            txn_file = "/home/eddy/datasets/zipfian/txnsx_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_Y) {
            init_file = "/home/eddy/datasets/zipfian/loadx_unif_int.dat";
            txn_file = "/home/eddy/datasets/zipfian/txnsy_unif_int.dat";
        } else if (kt == RANDINT_KEY && wl == WORKLOAD_Z) {
            init_file = "/home/eddy/datasets/custom/zipfian/insert_100/loada_unif_int.dat";
            txn_file = "/home/eddy/datasets/custom/zipfian/insert_100/txnsa_unif_int.dat";
        }
    }
...
void kvtest_ycsb(int workload, int method){
        // ycsb_data ycsb;
